...
def define_lineas(str_divisiones):
	if(str_divisiones == "p"):
		imagen_lineas = draw_lines_p(image)
		return 1
	elif(str_divisiones == "m" or str_divisiones == "m2"):
		imagen_lineas = draw_lines_m(image)
		return 1
	elif(str_divisiones == "g"):
		imagen_lineas = draw_lines_g(image)
		return 1
	else:
		print "ERROR"
		return 0
...
def imprimir_notas_m(image, nota_inicial):
	...
	cv2.putText(image,notas2[0], (0,230), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[1], (160,230), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[2], (320,230), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[3], (480,230), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[4], (0,470), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[5], (160,470), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[6], (320,470), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
	cv2.putText(image,notas2[7], (480,470), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
...
def imprimir_notas_g(image, nota_inicial):
	...
	cv2.putText(image,notas2[0], (0,110), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[1], (160,110), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[2], (320,110), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[3], (480,110), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[4], (0,230), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[5], (160,230), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[6], (320,230), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[7], (480,230), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[8], (0,350), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[9], (160,350), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[10], (320,350), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[11], (480,350), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[12], (0,470), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[13], (160,470), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	cv2.putText(image,notas2[14], (320,470), cv2.FONT_HERSHEY_SIMPLEX, 2, 255, 2)
	#cv2.putText(image,notas2[15], (480,470), cv2.FONT_HERSHEY_SIMPLEX, 3, 255, 3)
...
if __name__ == "__main__":
	...
	while 1:
		...
		#if str_divisiones == "g":
		#	imprimir_notas_g([],image,nota_inicial)
		
		if str_divisiones == "m":
			imprimir_notas_m(image, nota_inicial)
		if str_divisiones == "m2":
			imprimir_notas_n(image, nota_inicial)
		if str_divisiones == "g":
			imprimir_notas_g(image, nota_inicial)
		...
		if centroides:
			if(str_divisiones == "p"):
				...
				#imprimir_notas_g(cuadrantes,image, nota_inicial)
